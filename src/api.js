...
export const api = {
  ...
  searchConsume: (category, productId) => req("/search/consume", { method: "POST", auth: true, body: { category, productId } }),
  ...
  adminWaStatus: () => req("/portal/admin/wa/status"),
  adminWaFaqs: () => req("/portal/admin/wa/faqs"),
